  ...
  - class: '5.9'
    ...
    closed:
      - question: K čemu slouží formát SVG?
        answer: >-
          Pro ukládání dat o vektorových grafických objektech. Má přímou podporu
          HTML5.
      ...
      - question: Co je to AJAX?
        answer: >-
          Asynchronous JavaScript and XML - soubor technologií umožňujících
          vytvářet online aplikace (HTML, JavaScript, XMLHttpRequest, DOM).
        remove: true
      ...
      - question: Co jsou big data?
        answer: >-
          ...
          zpracovávat data běžně používanými
          prostředky.[](https://cs.wikipedia.org/wiki/Software "Software")
---
